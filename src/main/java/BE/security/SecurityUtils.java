...
public class SecurityUtils {
    ...
    static final String AUTHORISATION_HEADER = "Authorisation";
    static final String TOKEN_BEARER_STRING_FOR_APPENDING = "Bearer ";
    ...
    public static void validateRequestStructure(String username, String password, String grant_type, String refresh_token) {
        ...
        if (grant_type.equals(GrantTypes.PASSWORD.toString())) {
            ...
            if (refresh_token == null) throw new CustomAuthenticationException(NO_REFRESH_TOKEN_ERROR_MESSAGE, AuthenticationFailureType.INVALID_REQUEST);
        } else {
